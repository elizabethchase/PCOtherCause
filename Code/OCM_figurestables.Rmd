...
rm(list=c("subperf", "rforestroc", "cox55roc", "cox40roc", "rforest_40", "cox_55", "cox55_plco", "cox40_plco", "forest_plco", "ssa_roc", "nvss_roc"))
```
...
myplot <- ggplot() + geom_line(data = calibration5_data, aes(x=Group, y=Est), 
  ...
  labs(caption = "Black line: perfect calibration. Blue line: calibration at 
       ...
       at 14 years.") #+ theme(text=element_text(size=18))
...
Patient 1 (very high risk): age 85, no comorbidities, some college, married, current smoker, BMI 25-40
